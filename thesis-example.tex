...
% If you have two instructors, separate them with \\ to create linefeeds
 \newcommand{\INSTRUCTOR}{Pekka Röytä M.Sc. (Tech.)\\
  %Elli Opas M.Sc. (Tech)
  }
\newcommand{\FINSTRUCTOR}{Diplomi-insin{\"o}{\"o}ri Olli Ohjaaja\\
...
\newcommand{\KEYWORDS}{machine learning,deep learning, spectroscopy, data augmentations, SMOTE, GANs, data-warping,nural network}
...
\startchapright\input{3methods.tex}
 
\startchapright\input{4implementation.tex}

\startchapright\input{5evaluation.tex}
 
\startchapright\input{6discussion.tex}
 
\startchapright\input{7conclusions.tex}
